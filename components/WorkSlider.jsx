              ...
              <div key={imageI} style={{ perspective: "1000px" }}>
                <motion.div>
                  ...
                  <CardContainer className="relative rounded-2xl">
                    <CardBody
                      className={`group/card relative h-[17.5rem] w-full rounded-2xl border border-accent/40 bg-matte p-4 hover:border-accent hover:shadow-glow sm:h-[18.5rem] sm:p-5 md:h-[19rem] ${
                        imageI === slide.images.length - 1 ? "mb-8 xl:mb-10" : ""
                      }`}
                    >
                      <CardItem translateZ="45" className="text-sm font-semibold tracking-wider md:text-base">
                        {image.title}
                      </CardItem>
                      <CardItem
                        as="p"
                        translateZ="58"
                        className="mt-2 max-w-sm text-[11px] text-white/65 md:text-sm"
                      >
                      ...
                      >
                        <CardItem translateZ="100" className="mt-3 w-full gap-x-1 md:mt-4">
                          <Image
                            src={image.path}
                            alt={image.title}
                            height={300}
                            ...
                            className="mb-2 h-36 w-full rounded-xl object-cover transition-all duration-300 group-hover/card:shadow-xl sm:h-40"
                          />
                        </CardItem>
                      </Link>
                    </CardBody>
